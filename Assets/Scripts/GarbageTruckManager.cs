...
public class GarbageTruckManager : EnemyManager
{

    public GameObject garboMinion;
    ...
    void SpawnRatMinion() {
        GameObject rat = Instantiate(garboMinion, transform.position, Quaternion.identity);
    }
